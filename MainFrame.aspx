...
<HTML>
	...
	<frameset id="fraMain" border="0" frameSpacing="0" rows="90,*,25" frameBorder="0" runat="server">
		...
		<frameset id="Bottom" name="Bottom" border="0" frameSpacing="0" frameBorder="0" cols="142,*"
			...
			<frame id="main" name="main" src="PersonInfo/BrowNewsList.aspx" scrolling="auto" runat="server"><!-- MainFrm.aspx -->
			</frame>
		</frameset>
