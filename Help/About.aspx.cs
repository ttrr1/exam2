...
namespace EasyExam.Help
{
	...
	public partial class About : System.Web.UI.Page
	{
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			...
			strAboutInfo=strAboutInfo+"<td width='513' height='20'>网络考试系统&nbsp; 版本：V3.0</td>";
			strAboutInfo=strAboutInfo+"</tr>";
			strAboutInfo=strAboutInfo+"<tr>";
			strAboutInfo=strAboutInfo+"<td width='17' height='20'>";
			strAboutInfo=strAboutInfo+"</td>";
			strAboutInfo=strAboutInfo+"<td width='513' height='20'>作者：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";
			strAboutInfo=strAboutInfo+" </td>";
			strAboutInfo=strAboutInfo+"</tr>";
			strAboutInfo=strAboutInfo+"<tr>";
			strAboutInfo=strAboutInfo+"<td width='17' height='20'>";
			strAboutInfo=strAboutInfo+"</td>";
			strAboutInfo=strAboutInfo+"<td width='513' height='20'>QQ： E_mail：</td>";
			strAboutInfo=strAboutInfo+"</tr>";
			strAboutInfo=strAboutInfo+"<tr>";
			strAboutInfo=strAboutInfo+"<td width='12' height='20'></td>";
			strAboutInfo=strAboutInfo+"<td width='225' height='20'> 版权所有 &copy;2008-2011</td>";
			strAboutInfo=strAboutInfo+"</tr>";
			strAboutInfo=strAboutInfo+"<tr>";
