								...
								<td align="center">
									<TABLE id="Table2" style="BORDER-COLLAPSE: collapse" borderColor="#111111" cellSpacing="0"
										...
										<TR>
											...
											<td style="HEIGHT: 23px" width="336"><asp:textbox id="txtCertType" runat="server" CssClass="text"  Enabled="false"></asp:textbox></td>
										</TR>
										<TR>
										...
										<TR>
											...
											<td width="336" height="23"><asp:dropdownlist id="DDLUserType" runat="server" Width="80px"  Enabled="false">
