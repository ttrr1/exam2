...
<HTML>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table height="563" cellSpacing="0" cellPadding="0" width="800" align="center" border="0">
				<tr>
					<td height="40"></td>
				</tr>
				<tr>
					<td>
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="523" cellSpacing="0"
							...
							<TR>
								<TD height="23">&nbsp; 试题内容：<asp:TextBox id="txtTestContent" runat="server" Width="290px"></asp:TextBox>
