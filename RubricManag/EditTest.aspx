	...
	<HEAD>
        ...
        <script language="javascript">
		    ...
		    function OpenHtmlEditor(index) {
		        ...
		        var content = document.getElementById("txtTestContent" + index).value;
		        ...
		        if (top < 0) { top = 0; }
		        win = window.open("HtmlEditor.aspx?uu="+content, "HtmlEditor", "toolbar=no, menubar=no, scrollbars=no,resizable=no,location=no,status=yes,width=" + width + ",height=" + height + ",left=" + left + ",top=" + top);
		    }
