<%@ Page language="c#" Inherits="EasyExam.RubricManag.EditTest" CodeFile="副本 EditTest.aspx.cs" %>
								...
								<td width="586" colSpan="6" height="23" style="WORD-BREAK: break-all">
									<TABLE id="table1" cellSpacing="1" cellPadding="1" width="100%" border="0">
										<TR id="TR1" runat="server">
											...
											<TD vAlign="top" width="16"><a  href="javascript:void(txtTestContent0)"><IMG title="HTML编辑器" height="16" src="../Images/Html_Editor.GIF" width="16" border="0"></A></TD>
										</TR>
									</TABLE>
								</td>
							</TR>
