   ...
   <script language="javascript" type="text/javascript" src="../JavaScript/kindeditor-4.1.10/kindeditor.js"></script>
	...
	<body leftMargin="0" topMargin="0" rightMargin="0">
		<form id="Form1" method="post" runat="server">
			<table height="300" cellSpacing="0" cellPadding="0" width="750" align="center" border="0">
				<tr>
					<td height="0"></td>
				</tr>
				<tr>
					<td colspan="2">
						...
						<table style="BORDER-COLLAPSE: collapse" borderColor="#6699ff" height="336" cellSpacing="0"
							...
							<TR>
								...
								<td style="HEIGHT: 219px" width="650px" colSpan="5"><FONT face="宋体"><asp:TextBox runat="server" Height="248px" TextMode="MultiLine" ToolTip="最多可输入800个字符" Width="648px"
